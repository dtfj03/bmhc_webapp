...
<form method="POST" action="process/add-patient-process.php">
    ...
    <div class="patient-container">
        <div class="patient-data">
            ...
            <select name="patient_pobcity" required >
                <option name="neg_occ">Negros Occidental</option>
                <option name="neg_or">Negros Oriental</option>
            </select>
        </div>
        <div class="patient-data">
            <label for="patient_pobcity">City/Municipality</label><br>
            <input type="text" name="patient_pobcity" required />
        </div>
    </div><hr>
